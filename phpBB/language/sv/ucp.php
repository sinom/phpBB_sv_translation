...
$lang = array_merge($lang, array(
	...
	<br><br>
	Du samtycker till att inte publicera något kränkande, obscent, vulgärt, ärekränkande, hatiskt, hotfullt, sexuellt orienterat eller på annat sätt olagligt material, oavsett om det sker enligt lagarna i ditt land, det land där “%1$s” finns eller enligt internationell lag. Att göra det kan resultera i omedelbar och permanent avstängning, med meddelande till din internetleverantör om vi anser det nödvändigt. IP-adressen för alla inlägg registreras för att underlätta upprätthållandet av dessa villkor.
	<br><br>
	Du samtycker till att “%1$s” förbehåller sig rätten att ta bort, redigera, flytta eller stänga vilket ämne som helst när som helst, efter eget gottfinnande. Som användare samtycker du till att all information du anger kan lagras i en databas. Även om denna information inte kommer att lämnas ut till någon tredje part utan ditt samtycke, ska varken “%1$s” eller phpBB hållas ansvariga för eventuella hackningsförsök som kan leda till att data äventyras.
	',

	'PRIVACY_POLICY'		=> 'Denna policy förklarar i detalj hur “%1$s” och dess dotterbolag (nedan kallade “vi”, “oss”, “vår”, “%1$s”, “%2$s”) och phpBB (nedan kallade “de”, “dem”, “deras”, “phpBB-programvara”, “www.phpbb.com”, “phpBB Limited”, “phpBB Teams”) använder information som samlas in under din användning av denna webbplats (nedan kallade “din information”).
	<br><br>
	Din information samlas in på två sätt. När du surfar på “%1$s” skapar phpBB-programvaran flera cookies. Cookies är små textfiler som lagras i din webbläsares temporära filer. De två första cookies innehåller en användaridentifierare (nedan kallad “användar-ID”) och en anonym sessionsidentifierare (nedan kallad “session-ID”), båda tilldelade automatiskt av phpBB-programvaran. En tredje cookie skapas när du har bläddrat igenom ämnen i “%1$s”. Den lagrar information om vilka ämnen du har läst, vilket förbättrar din användarupplevelse.
	<br><br>
	Vi kan också komma att skapa cookies utanför phpBB-programvaran medan du surfar på “%1$s”. Dessa faller utanför ramen för detta dokument, som endast täcker cookies som skapats av phpBB-programvaran.
	<br><br>
	Det andra sättet vi samlar in information är genom det du skickar till oss. Detta inkluderar men är inte begränsat till: att posta som anonym användare (nedan kallade ”anonyma inlägg”), registrera dig på ”%1$s” (nedan kallade ”ditt konto”), inlägg du skickar in efter registrering och medan du är inloggad (nedan kallade ”dina inlägg”).
	<br><br>
	Ditt konto kommer att innehålla minst: ett unikt användarnamn (hädanefter kallat ”ditt användarnamn”), ett personligt lösenord som används för att logga in (hädanefter kallat ”ditt lösenord”), en giltig e-postadress (hädanefter kallat ”din e-postadress”). Din kontoinformation på ”%1$s” är skyddad av dataskyddslagarna som gäller i det land där vi är värd för. All information utöver ditt användarnamn, lösenord och e-postadress som begärs under registreringen kan vara obligatorisk eller valfri, efter ”%1$s” gottfinnande. I samtliga fall kan du välja vilken information i ditt konto som visas offentligt. Du kan också välja att ta emot eller avregistrera dig från automatiskt genererade e-postmeddelanden från phpBB-programvaran.
	<br><br>
	Ditt lösenord lagras som en envägshash för att garantera säkerheten. Vi rekommenderar dock att du inte använder samma lösenord på flera webbplatser. Ditt lösenord är nyckeln till ditt konto på “%1$s”, så håll det säkert. Under inga omständigheter kommer någon som är ansluten till “%1$s”, phpBB eller någon tredje part att legitimt be om ditt lösenord. Om du glömmer ditt lösenord kan du använda funktionen “Jag har glömt mitt lösenord” som tillhandahålls av phpBB-programvaran. Denna process kräver att du anger ditt användarnamn och din e-postadress, varefter phpBB-programvaran genererar ett nytt lösenord åt dig för att återfå åtkomst till ditt konto.
	',
));
...
$lang = array_merge($lang, array(
	...
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Gravatar är en tjänst som ger dig möjligheten att använda samma avatar/profilbild på flera sidor. Besök <a href="http://www.gravatar.com/">Gravatar</a> för mer information.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Galleri profilbild',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Du kan välja din profilbild från lokalt tillgängliga profilbilder.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Avlägsen profilbild',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Länka din profilbild från en annan hemsida.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Ladda upp profilbild',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Ladda upp din egna profilbild.',
	...
	'AVATAR_FEATURES_DISABLED'		=> 'Stödet för profilbilder är för närvarande inaktiverat.',
	'AVATAR_GALLERY'				=> 'Lokalt galleri',
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'Kunde inte ladda upp profilbild till %s.',
	'AVATAR_NOT_ALLOWED'			=> 'Din profilbild kan inte visas, eftersom funktionen för visning av profilbilder har inaktiverats.',
	'AVATAR_PAGE'					=> 'Sida',
	'AVATAR_SELECT'					=> 'Välj din profilbild',
	'AVATAR_TYPE'					=> 'Typ av profilbild',
	'AVATAR_TYPE_NOT_ALLOWED'		=> 'Din nuvarande profilbild kan inte visas, eftersom denna typ av profilbilder har förbjudits.',
	...
	'CANNOT_MOVE_TO_SAME_FOLDER'=> 'Meddelandena kan inte flyttas till den katalog som du vill ta bort.',
	'CANNOT_MOVE_FROM_SPECIAL'	=> 'Meddelanden kan inte flyttas från utkorgen.',
	'CANNOT_RENAME_FOLDER'		=> 'Det går inte att byta namn på denna katalog.',
	'CANNOT_REMOVE_FOLDER'		=> 'Det går inte att ta bort denna katalog.',
	'CHANGE_DEFAULT_GROUP'		=> 'Byt standardgrupp',
	'CHANGE_PASSWORD'			=> 'Byt lösenord',
	'CLICK_GOTO_FOLDER'			=> '%1$sGå till din “%3$s”-katalog%2$s',
	'CLICK_RETURN_FOLDER'		=> '%1$sÅtergå till din “%3$s”-katalog%2$s',
	...
	'CREATE_FOLDER'				=> 'Lägg till katalog …',
	...
	'DELETE_AVATAR'				=> 'Ta bort profilbild',
	...
	'FIELD_TOO_SMALL'					=> 'Värdet av “%2$s” är för lågt, det måsta vara lika med eller högre än %1$d.',
	'FIELD_TOO_LARGE'					=> 'Värdet av “%2$s” är för högt, det största värdet som är tillåtet är %1$d.',
	...
	'FOLDER_OPTIONS'			=> 'MKatalogalternativ',
	'FOLDER_RENAMED'			=> 'Bytte namn på katalogen.',
	'FOLDER_REMOVED'			=> 'Katalogen togs bort.',
	'FOLDER_STATUS_MSG'	=>	array(
		1	=>			'Katalogen är %3$d%% full (%2$d av %1$s lagrade)',
		2	=>			'Katalogen är %3$d%% full (%2$d av %1$s lagrade)',
	),
	...
	'FULL_FOLDER_OPTION_CHANGED'=> 'Åtgärden som ska utföras när en katalog är full har ändrats.',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Ange den e-postadress som du använt vid registreringen hos <a href="http://www.gravatar.com/">Gravatar</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Gravatar-dimensioner',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Ange höjd och bredd för Gravatar/profilbilden, lämna tomt för att försöka verifiera automatiskt.',
	...
	'IF_FOLDER_FULL'			=> 'Om Katalogen är full',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'=> 'Ange URL:en för platsen som innehåller profilbilden som du vill länka till.',
	'LINK_REMOTE_SIZE'			=> 'Dimensioner för profilbild',
	'LINK_REMOTE_SIZE_EXPLAIN'	=> 'Ange bredden och höjden på profilbilden, lämna tomt för att försöka automatiskt.',
	...
	'MAX_FOLDER_REACHED'			=> 'Det maximala antalet användarskapade kataloger har uppnåtts.',
	...
	'MOVE_PM_ERROR'	=>	array(
		1	=>			'Ett fel uppstod när meddelandena flyttades till den nya katalogen, endast %2$d av %1$s meddelanden flyttades.',
		2	=>			'Ett fel uppstod när meddelandena flyttades till den nya katalogen, endast %2$d av %1$s meddelanden flyttades.',
	),
	'MOVE_TO_FOLDER'				=> 'Flytta till katalog',
	'MOVE_UP'						=> 'Flytta upp',

	'NEW_FOLDER_NAME'				=> 'Nytt katalognamn',
	...
	'NOT_ENOUGH_SPACE_FOLDER'		=> 'Målkatalogen “%s” verkar vara full. Den valda åtgärden har inte utförts.',
	'NOT_MOVED_MESSAGES'	=>	array(
		1	=>			'Du har 1 personligt meddelande som hålls tillbaka på grund av full katalog.',
		2	=>			'Du har %d personliga meddelanden som hålls tillbaka på grund av full katalog.',
	),
	'NO_ACTION_MODE'				=> 'Ingen meddelandeåtgärd specificerad.',
	'NO_AUTHOR'						=> 'Ingen författare definierad för detta meddelande',
	'NO_AVATAR'						=> 'Ingen profilbild är vald',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Du har inte behörighet att skriva ut personliga meddelanden.',
	'NO_AUTH_SIGNATURE'				=> 'Du har inte behörighet att använda signaturer.',
	'EMAIL_NOT_UNIQUE'				=> 'E-postadressen du angav används av flera användare. Du måste också ange användarnamn.',
	...
	'NO_NEW_FOLDER_NAME'		=> 'Du måste ange ett nytt katalognamn.',
	...
	'PM_MARK_ALL_READ_SUCCESS'	=> 'Alla privata meddelanden i denna katalogen har blivit markerade som lästa',
	...
	'RELEASE_MESSAGES'					=> '%sSläpp alla tillbakahållna meddelanden%s… de kommer sorteras in i passande katalog om det finns tillräckligt med plats.',
	...
	'REMOVE_FOLDER'						=> 'Ta bort katalog',
	'REMOVE_FOLDER_CONFIRM'				=> 'Är du säker på att du vill ta bort denna katalog?',
	'RENAME'							=> 'Byt namn',
	'RENAME_FOLDER'						=> 'Byt namn på katalogen',
	...
	'RETURN_FOLDER'						=> '%1$sÅtergå till föregående katalog%2$s',
	...
	'UCP_PM_OPTIONS'			=> 'Regler, kataloger &amp; inställningar',
	'UCP_PM_UNREAD'				=> 'Olästa meddelanden',
	'UCP_PM_VIEW'				=> 'Visa meddelanden',

	'UCP_PROFILE'				=> 'Profil',
	'UCP_PROFILE_AVATAR'		=> 'Ändra profilbild',
	...
	'VIEW_AVATARS'				=> 'Visa profilbilder',
	...
	'PM_ACTION'	=>	array(
		'PLACE_INTO_FOLDER'	=>			'Placera i katalog',
