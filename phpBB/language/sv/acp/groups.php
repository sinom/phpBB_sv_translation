...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT'			=> 'Gruppens gräns för antal personliga meddelande per katalog',
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Denna inställning åsidosätter standardgränsen för antal meddelanden per katalog. Ange 0 för att använda användarens standardgräns.',
	...
	'LEGEND_EXPLAIN'				=> 'Följande grupper visas i gruppförklaringen:',
	'LEGEND_SETTINGS'				=> 'Förklaringsinställningar',
	'LEGEND_SORT_GROUPNAME'			=> 'Sortera förklaring efter gruppnamn',
	'LEGEND_SORT_GROUPNAME_EXPLAIN'	=> 'Ordningsföljden nedan ignoreras när detta är ikryssad.',

	'MANAGE_LEGEND'			=> 'Hantera gruppförklaring',
