...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Detta är texten som kommer att visas på framsidan av forumet. Om inget anges används "Forumindex".',
	...
	'DISPLAY_LAST_SUBJECT'			=> 'Visa ämnet av det senast skapade inlägget i forumlistan',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Ämnet av det senast skapade inlägget kommer att visas i forumlistan med en länk till inlägget. Ämnen i lösenordsskyddade forum kommer inte att visas för obehöriga.',
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Visa ej godkända inlägg till författaren',
	...
	'SITE_HOME_URL_EXPLAIN'			=> 'Om specifierad så kommer titeln på hemsidan att länka till denna länk istället för indexsidan av forumet. En absolut länk krävs, t.ex. <samp>http://www.phpbb.se</samp>.',
...
// Avatar Settings
$lang = array_merge($lang, array(
	'ACP_AVATAR_SETTINGS_EXPLAIN'	=> 'Profilbilder är i allmänhet små, unika bilder en användare kan förknippa sig med. Beroende på stilen så visas de under användarnamnet i trådar. Här kan du bestämma hur användare kan definiera sina profilbilder. Observera att för att ladda upp profilbilder så måste du ha skapat katalogen du anger nedan och försäkra dig om att den kan skrivas till av webbservern. Kom också ihåg att filstorleksgränser endast beläggs på uppladdade profilbilder, inte på fjärrlänkade bilder.',

	'ALLOW_AVATARS'					=> 'Aktivera profilbilder',
	'ALLOW_AVATARS_EXPLAIN'			=> 'Tillåt allmän användning av profilbilder. <br />Om du inaktiverar profilbilder överlag eller av specifik typ, så kommer inaktiverade profilbilder inte längre att visas i forumet. Användarna har ännu möjlighet att ladda ner sina egna profilbilder i kontrollpanelen.',
	'ALLOW_GRAVATAR'				=> 'Tillåt Gravatar-profilbilder',
	'ALLOW_LOCAL'					=> 'Aktivera galleriprofilbilder',
	'ALLOW_REMOTE'					=> 'Aktivera fjärrprofilbilder',
	'ALLOW_REMOTE_EXPLAIN'			=> 'Profilbilder som länkas till på en annan webbplats.',
	'ALLOW_REMOTE_UPLOAD'			=> 'Aktivera uppladdning av fjärrprofilbilder',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Tillåt att profilbilder laddas upp från extern webbplats.',
	'ALLOW_UPLOAD'					=> 'Aktivera uppladdning av profilbilder',
	'AVATAR_GALLERY_PATH'			=> 'Sökväg till profilbildsgalleri',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Sökväg under din phpBB-rotkatalog, t.ex. <samp>images/avatars/gallery</samp>.',
	'AVATAR_STORAGE_PATH'			=> 'Sökväg till profilbilder (denna funktion kommer inte att fungera om katalogen inte är skrivbar)',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Sökväg under din phpBB-rotkatalog, t.ex. <samp>images/avatars/upload</samp>.',
	'MAX_AVATAR_SIZE'				=> 'Maximala profilbildsdimensioner. Om detta värde är 0, begränsas storleken på filen som ska laddas upp endast av din PHP-konfiguration',
	'MAX_AVATAR_SIZE_EXPLAIN'		=> 'Bredd x höjd i pixlar.',
	'MAX_FILESIZE'					=> 'Maximal filstorlek för profilbilder',
	'MAX_FILESIZE_EXPLAIN'			=> 'För uppladdade profilbilder.',
	'MIN_AVATAR_SIZE'				=> 'Minsta profilbildsdimensioner',
...
$lang = array_merge($lang, array(
	...
	'BOXES_LIMIT'				=> 'Maximalt antal personliga meddelanden per katalog',
	'BOXES_LIMIT_EXPLAIN'		=> 'Användare får ta emot upp till så här många meddelanden i varje katalog. Sätt detta värde till 0 för att tillåta obegränsat med personliga meddelanden.',
	'BOXES_MAX'					=> 'Maximalt antal personliga meddelandekataloger',
	'BOXES_MAX_EXPLAIN'			=> 'Som standard kan användare skapa så här många personliga kataloger för personliga meddelanden.',
	'ENABLE_PM_ICONS'			=> 'Aktivera användning av trådikoner i personliga meddelanden',
	'FULL_FOLDER_ACTION'		=> 'Standardåtgärd vid full katalog',
	'FULL_FOLDER_ACTION_EXPLAIN'=> 'Standardåtgärd att utföra om en användares katalog är full om inte användarens åtgärd vid full katalog kan användas eller är inställd. Det enda undantaget är för "Skickat"-katalogen där standardåtgärden alltid är att ta bort gamla meddelanden.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Aktiverar HTTP-autentisering, vilket gör att användare kan komma åt innehåll som är dolt för gäster genom att lägga till parametern <samp>auth=http</samp> i flödets URL. Observera att vissa PHP-konfigurationer kan kräva ytterligare ändringar i .htaccess-filen; se den filen för vägledning. HTTP-autentisering stöds endast över krypterade (https) anslutningar.',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN_EXPLAIN'		=> 'I de flesta fall är cookiedomänen valfri. Lämna den tom om du är osäker.<br><br> Om du har ett forum integrerat med annan programvara eller har flera domäner, måste du göra följande för att bestämma cookiedomänen. Om du har något som <i>example.com</i> och <i>forums.example.com</i>, eller kanske <i>forums.example.com</i> och <i>blog.example.com</i>. Ta bort underdomänerna tills du hittar den gemensamma domänen, <i>example.com</i>. Lägg nu till en punkt framför den gemensamma domänen så anger du .example.com (notera punkten i början).',
	'COOKIE_NAME'				=> 'Namn på cookie',
	'COOKIE_NAME_EXPLAIN'		=> 'Detta kan vara vad du vill, gör det originellt. När cookieinställningarna ändras bör namnet på cookien ändras.',
...
$lang = array_merge($lang, array(
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'Användares aktivitet begränsning',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'Aktiv tråd/kategori kommer ej att visas för användare med fler än det inställda antalet inlägg. Still in till 0 för att deaktivera begränsningen.',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Både nyckeln samt hemligheten av OAuth-tjänsten måste fyllas i. Endast en av de två var ifyllda.',
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Varje OAuth-tjänst kräver en unik hemlighet och nyckel för att kunna autentisera med den externa servern. <br />Dessa skall tillgodoses av OAuth-tjänsten när du registrera.',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE_EXPLAIN' => 'Om aktiverad, länkar kommer som innehåller t.ex ’app.php’ kommer att skrivas om så att filnamnet inte syns. (T.ex. app.php/foo kommer att bli enbart /foo). <strong>Apaches mod_rewrite modul krävs av servern för att detta skall fungera.</strong>',
...
$lang = array_merge($lang, array(
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Tillåt anslutningar till SMTP-server med självsignerade SSL-certifikat. <em><strong>Varning:</strong> Tillåtelse av självsignerade SSL-certifikat kan orsaka säkerhetsimplikationer.</em>',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Kräv verifikation av SSL-certifikat som används av SMTP-server. <em><strong>Varning:</strong> Anslutande med overifierade SSL-certifikat kan orsaka säkerhetsimplikationer.</em>',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED' 	=> 'Tillåt självsignerade SSL-certifikat',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN' => 'Tillåt anslutningar till Jabber-server med självsignerat SSL-certifikat. <br><em><strong>Varning:</strong> Att tillåta självsignerade SSL-certifikat kan medföra säkerhetsrisker.</em>',
	...
	'JAB_VERIFY_PEER' 			=> 'Verifiera SSL-certifikat',
	'JAB_VERIFY_PEER_EXPLAIN' 	=> 'Kräv verifiering av SSL-certifikat som används av Jabber-servern. <br><em><strong>Varning:</strong> Att ansluta till motparter med ej verifierade SSL-certifikat kan medföra säkerhetsrisker.</em>',
	'JAB_VERIFY_PEER_NAME' 		=> 'Verifiera Jabbers servernamn (peer name)',
	'JAB_VERIFY_PEER_NAME_EXPLAIN' => 'Kräv verifiering av värddatornamn (peer name) för Jabber-servrar som använder SSL- / TLS-anslutningar. <br><em><strong>Varning:</strong> Att ansluta till overifierade värddatorer kan medföra säkerhetsrisker.</em>',
));
