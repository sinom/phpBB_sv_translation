...
$lang = array_merge($lang, array(
	...
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Här kan du tilldela globala behörigheter till grupper - användarbehörigheter, globala moderationsbehörigheter och administrativa behörigheter. Användarbehörigheter inkluderar funktioner så som profilbilder, personliga meddelanden, osv.; globala moderationsbehörigheter så som godkännande av inlägg, trådhantering, bannlysningar, osv. och till slut administrativa behörigheter så som ändring av behörigheter, egna BBCodes, kategorihantering, osv. Individuella användarbehörigheter bör endast ändras vid sällsynta tillfällen, den föredragna metoden är att placera användare i grupper och sedan tilldela gruppbehörigheter.',
	...
	'ROLE_USER_NOAVATAR'		=> 'Ingen profilbild',
	...
	'ROLE_DESCRIPTION_USER_NOAVATAR'		=> 'Har en begränsad uppsättning funktioner och kan inte använda profilbilder.',
