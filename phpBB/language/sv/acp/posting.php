...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'RELATIVE_URL'		=>			'En relativ URL. Du kan använda detta för att matcha delar av en URL, men var försiktig: en full URL är en godkänd relativ URL. När du vill använda relativa URLs på ditt forum, använd LOCAL_URL strängen.',
		...
		'ALNUM'			=> 'Tecken från det latinska alfabetet (A-Z) och siffror.',
		'CHOICE'		=> 'Ett urval av specificerade värden, t.ex. <samp>{CHOICE=spader,hjärtor,ruter,klöver}</samp>. Värdena behandlas som skiftlägesokänsliga som standard och kan behandlas skiftlägeskänsliga genom att ange alternativet <samp>caseSensitive</samp> val: <samp>{CHOICE=Spader,Hjärter,Ruter,Klöver;caseSensitive}</samp>',
		'FLOAT'			=> 'Ett decimalvärde, t.ex. <samp>0,5</samp>.',
		'HASHMAP'		=> 'Mappar strängar till deras ersättare i formen <samp>{HASHMAP=string1:replacement1,string2:replacement2}</samp>. Skiftlägeskänslig. Bevarar okända värden som standard.',
		'INT'			=> 'Ett heltalsvärde, t.ex. <samp>2</samp>.',
		'IP'			=> 'En giltig IPv4-eller IPv6-adress.',
		'IPPORT'		=> 'En giltig IPv4-eller IPv6-adress med portnummer.',
		'IPV4'			=> 'En giltig IPv4-adress.',
		'IPV6'			=> 'En giltig IPv6-adress.',
		'MAP'			=> 'Mappar strängar till deras ersättning i formen <samp>{MAP=sträng1:ersättning1,sträng2:ersättning2}</samp>. Skiftlägesokänslig. Bevarar okända värden som standard.',
		'RANGE'			=> 'Accepterar ett heltal i det givna intervallet, t.ex. <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Validerar dess värde mot ett givet regexp, t.ex. <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'En tidsstämpel som <samp>1h30m10s</samp> som kommer att konverteras till ett antal sekunder. Accepterar även ett nummer.',
		'UINT'			=> 'Ett heltalsvärde utan tecken. Samma som <samp>{INT}</samp>, men avvisar värden mindre än 0.',
	),
));
