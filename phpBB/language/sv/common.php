...
$lang = array_merge($lang, array(
	...
	'NOTIFICATION_POST_DISAPPROVED'		=> '<strong>Inlägg underkänt</strong>:',
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>Inläggsgodkännande</strong> förfrågad utav %1$s:',
	'NOTIFICATION_QUOTE'	=>	array(
		1	=>			'<strong>Quoted</strong> by %1$s in:',
	),
	'NOTIFICATION_REFERENCE'			=> '"%1$s"',
	'NOTIFICATION_REASON'				=> '<em>Anledning:</em> %1$s.',
	'NOTIFICATION_REPORT_PM'			=> '<strong>Privat Meddelande rapporterat</strong> by %1$s:',
	'NOTIFICATION_REPORT_PM_CLOSED'		=> '<strong>Rapporten om privat meddelande är stängd</strong> by %1$s:',	
	'NOTIFICATION_REPORT_POST'			=> '<strong>Inlägg rapporterat</strong> by %1$s:',
	...
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '<strong>Tråd underkänd</strong>:',
