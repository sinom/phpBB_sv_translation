...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> 'Denna externa tjänst är redan associerat med ett annat forumkonto.',
	...
	'AVATAR_EMPTY_REMOTE_DATA'		=> 'Den valda profilbilden kunde inte laddas upp eftersom datan verkar vara felaktig eller korrupt.',
	'AVATAR_EMPTY_FILEUPLOAD'		=> 'Den uppladdade profilbilden är tom.',
	'AVATAR_INVALID_FILENAME'		=> '%s är ett felaktigt filnamn.',
	'AVATAR_NOT_UPLOADED'			=> 'Profilbilden kunde inte laddas upp.',
	'AVATAR_NO_TEMP_DIR'			=> 'Temporär katalog kunde inte hittas eller är ej skrivbar',
	'AVATAR_NO_SIZE'				=> 'Kunde inte hitta höjd och bredd på profilbilden, ange dessa manuellt.',
	'AVATAR_NO_UPLOAD_DIR'			=> 'Profilbildens sökväg finns inte eller är inte skrivbar.',
	'AVATAR_NO_UPLOAD_PATH'			=> 'Uppladdning av profilbild är aktiverat men sökvägen för profilbilden  är inte angiven.',
	'AVATAR_PARTIAL_UPLOAD'			=> 'Den valda filen laddades endast upp delvis.',
	'AVATAR_PHP_SIZE_NA'			=> 'Profilbildens filstorlek är för stor.<br />Kunde inte hitta maximalstorleken definierad av PHP i php.ini.',
	'AVATAR_PHP_SIZE_OVERRUN'		=> 'Profilbildens filstorlek är för stor, den största tillåtna storleken för uppladdade filer är %1$d %2$s.<br />Detta har definierats i php.ini och kan inte överskridas.',
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> 'Profilbilden kunde inte laddas upp eftersom förfrågan tog för lång tid.',
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'Ett PHP-tillägg har stoppat filuppladdningen', 
	'AVATAR_URL_INVALID'			=> 'URL:en du angav är felaktig.',
	'AVATAR_URL_NOT_FOUND'			=> 'Filen kunde inte hittas.',
	'AVATAR_WRONG_FILESIZE'			=> 'Profilbildens filstorlek måste vara mellan 0 och %1$d %2$s.',
	'AVATAR_WRONG_SIZE'				=> 'Den valda profilbilden är %5$s pixlar bred och %6$s pixlar hög. Profilbilder måste vara minst %1$s pixlar breda och %2$s pixlar höga, men inte större än %3$s bred och %4$s hög.',
	...
	'CONFIRM_AVATAR_DELETE' => 'Är du säker på att du vill ta bort din profilbild?',
	...
	'DELETE_COOKIES'		=> 'Ta bort alla kakor',
	...
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> 'Den angivna e-postdomänen har ingen giltig MX-post.',
	...
	'FEATURE_NOT_AVAILABLE' => 'Den begärda funktionen finns inte på detta forum.',
	'FILENAME'				=> 'Filnamn',
	'FILESIZE'				=> 'Filstorlek',
	'FILEDATE'				=> 'Fildatum',
	'FILE_COMMENT'			=> 'Filkommentar',
	'FILE_CONTENT_ERR'		=> 'Kunde inte läsa innehållet av filen: %s',
	...
	'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'		=> 'Det gick inte att ändra filgruppen',
	'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'	=> 'Det gick inte att ändra filtillstånd',
	'FILESYSTEM_CANNOT_COPY_FILES'				=> 'Det går inte att kopiera filer',
	'FILESYSTEM_CANNOT_CREATE_SYMLINK'			=> 'Det går inte att skapa en symlink',
	'FILESYSTEM_CANNOT_CREATE_DIRECTORY'		=> 'Det går inte att skapa katalog',
	'FILESYSTEM_CANNOT_DELETE_FILES'			=> 'Det går inte att radera filer från systemet',
	'FILESYSTEM_CANNOT_DUMP_FILE'				=> 'Det går inte att dumpa i filen',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'		=> 'Det går inte att spegla katalogen',
	'FILESYSTEM_CANNOT_RENAME_FILE'				=> 'Det går inte att byta namn på en fil från systemet',
	'FILESYSTEM_CANNOT_TOUCH_FILES'				=> 'Det går inte att skapa fil eller ändra filstämplar',
	...
	'INVALID_FEED_ATTACHMENTS'	=> 'Den valda feeden försökte fånga tillägg med ogiltiga metoder.',
	...
	'NOTIFICATION_GROUP_REQUEST'		=> '<strong>Gruppförfrågan</strong> från %1$s för att gå med i gruppen: %2$s.',
	'NOTIFICATION_GROUP_REQUEST_APPROVED'	=> '<strong>Gruppförfrågan godkänd</strong> för att gå med i gruppen: %1$s.',
	'NOTIFICATION_METHOD_INVALID'		=> 'Metoden "%s" hänvisar inte till en giltig notifieringsmetod.',
	'NOTIFICATION_PM'					=> '<strong>Privat Meddelande</strong> från %1$s:',
	'NOTIFICATION_POST'	=>	array(
		1	=>			'<strong>Svar</strong> från %1$s i tråden:',
	),
	'NOTIFICATION_POST_APPROVED'		=> '<strong>Inlägg godkänt</strong>:',
	'NOTIFICATION_POST_DISAPPROVED'		=> '<strong>Inlägg ej godkänt</strong>:',
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>Inläggsgodkännande</strong> förfrågat av %1$s:',
	'NOTIFICATION_QUOTE'	=>	array(
		1	=>			'<strong>Citerad</strong> av %1$s i:',
	),
	'NOTIFICATION_REFERENCE'			=> '"%1$s"',
	'NOTIFICATION_REASON'				=> '<em>Anledning:</em> %1$s.',
	'NOTIFICATION_REPORT_PM'			=> '<strong>Privat Meddelande rapporterat</strong> av %1$s:',
	'NOTIFICATION_REPORT_PM_CLOSED'		=> '<strong>Rapporten om privat meddelande är stängd</strong> av %1$s:',	
	'NOTIFICATION_REPORT_POST'			=> '<strong>Inlägg rapporterat</strong> av %1$s:',
	'NOTIFICATION_REPORT_CLOSED'		=> '<strong>Rapport stängd</strong> av %1$s för:',
	'NOTIFICATION_TOPIC'				=> '<strong>Ny tråd</strong> av %1$s:',
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>Tråd godkänd</strong>:',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '<strong>Tråd ej godkänd</strong>:',
	...
	'NO_AVATARS'				=> 'Inga profilbilder är tillgängliga',
	...
	'NO_STYLE_DATA'				=> 'Kunde inte hitta stildata för user_style %s och sätta det för user_id %s',
	'NO_STYLE_CFG'				=> 'Kunde inte hitta stilens konfigurationsfil för: %s',
	...
	'POST_DELETED_BY'		=> '<strong>%2$s</strong> tog bort inlägget av <strong>%1$s</strong> den %3$s.',
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong> tog bort inlägget av <strong>%1$s</strong> den %3$s med följande anledning: %4$s',
	...
	'POST_UNAPPROVED_EXPLAIN'	=> 'Det här inlägget är inte synligt för andra användare förrän det har godkänts av en moderator.',
	...
	'TOPIC_UNAPPROVED_FORUM'=> array(
		1=> 'Tråd i väntan på godkännande',
		2=> 'Inlägg i väntan på godkännande',
	),
	...
	'URL_REDIRECT'			=> 'Om din webbläsare ej har stöd för META omdirigering, %sklicka här för att bli omdirigerad%s.',
	'USERGROUPS'			=> 'Grupper',
	'USERNAME'				=> 'Användarnamn',
	'USERNAMES'				=> 'Användarnamn',
	'USER_AVATAR'			=> 'Användarens profilbild',
