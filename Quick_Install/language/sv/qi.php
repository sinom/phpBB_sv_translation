...
$lang = array_merge($lang, array(
	...
	'ADMIN_PASS_EXPLAIN' => 'Standard adminlösenordet som skall användas till dina forum. Detta kan ändras när forum är skapade.',
...
,
	...
	'WHO_ELSE_EXPLAIN' => '<ul><li>' . implode('</li><li>', array(
		...
		'Tack till phpBB.com MOD teamet (speciellt Josh, aka “A_Jelly_Doughnut”) för AutoMOD, som är inkluderat i detta paketet.',
	...
	'WHY' => 'Varför?',
	'WHY_EXPLAIN' => 'Precis som med phpBB2, om du gör mycket modifieringar (skapar modifieringar), så kan du inte placera alla moddar i en och samma phpBBinstallation. Så det är bäst att ha separerade installationer. Nu är problemet att det är ett hästjobb att kopier alla filer och genomlida installationsprocessen hela tiden. För att snabba upp detta, uppfanns Snabbinstallation.',
));
